...
| Agent             | Restrictions                                                                            |
| ----------------- | --------------------------------------------------------------------------------------- |
| oracle            | Read-only: cannot write, edit, or delegate (blocked: write, edit, task, call_harness_agent) |
| librarian         | Cannot write, edit, or delegate (blocked: write, edit, task, call_harness_agent)            |
| explore           | Cannot write, edit, or delegate (blocked: write, edit, task, call_harness_agent)            |
| multimodal-looker | Allowlist: `read` only                                                                  |
| atlas             | Cannot delegate (blocked: task, call_harness_agent)                                         |
...
Customize agent models, prompts, and permissions in `openagent-harness.jsonc`.
...
You can define custom categories in your plugin config file. During the rename transition, both `openagent-harness.json[c]` and legacy `openagent-harness.json[c]` basenames are recognized.
...
| Tool                  | Description                                                                                                                                                                                                                             |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **call_harness_agent**    | Spawn explore/librarian agents. Supports `run_in_background`.                                                                                                                                                                           |
...
Run `bunx openagent-harness doctor` to see capability diagnostics including:
