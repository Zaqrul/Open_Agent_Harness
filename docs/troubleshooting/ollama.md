...
When using Ollama as a provider with openagent-harness agents, you may encounter:
...
- **openagent-harness**: Passes through the SDK's behavior (can't fix at this layer)
...
**Tracking**: issue #1124 in this project’s tracker (use your host’s issue list).
...
- **openagent-harness**: issue #1124 in this project’s tracker
- **Ollama API Docs**: see the official Ollama documentation for the HTTP API (search for “Ollama API” in your browser).
