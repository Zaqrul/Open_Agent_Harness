...
| Agent | Denied Tools |
|-------|-------------|
| Oracle | write, edit, task, call_harness_agent |
| Librarian | write, edit, task, call_harness_agent |
| Explore | write, edit, task, call_harness_agent |
| Multimodal-Looker | ALL except read |
| Atlas | task, call_harness_agent |
