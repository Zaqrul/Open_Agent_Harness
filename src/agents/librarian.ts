...
export function createLibrarianAgent(model: string): AgentConfig {
  ...
  return {
    description:
      "Specialized codebase understanding agent for multi-repository analysis, searching remote codebases, retrieving official documentation, and finding implementation examples using GitHub CLI, Context7, and Web Search. MUST BE USED when users ask to look up code in remote repositories, explain library internals, or find usage examples in open source. (Librarian - Open Agent Harness)",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,
...
Step 4: Construct permalink
        https://<git-host>/owner/repo/blob/<sha>/path/to/file#L10-L20
\`\`\`
...
**Evidence** ([source](https://<git-host>/owner/repo/blob/<sha>/path#L10-L20)):
\\\`\\\`\\\`typescript
// The actual code
function example() { ... }
\\\`\\\`\\\`
...
\`\`\`
https://<git-host>/<owner>/<repo>/blob/<commit-sha>/<filepath>#L<start>-L<end>

Example:
https://<git-host>/tanstack/query/blob/abc123def/packages/react-query/src/useQuery.ts#L42-L50
\`\`\`
