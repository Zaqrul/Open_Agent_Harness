...
import type { OpenAgentHarnessConfig } from "../../config"
...
const isAgentDisabled = (agentConfigKey: string, config: OpenAgentHarnessConfig): boolean => {
...
const pickFallbackAgent = (config: OpenAgentHarnessConfig): CoreAgentKey => {
...
export const resolveRunAgent = (
  options: RunOptions,
  pluginConfig: OpenAgentHarnessConfig,
