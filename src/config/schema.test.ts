...
describe("OpenAgentHarnessConfigSchema - model_capabilities", () => {
  test("accepts valid model capabilities config", () => {
    ...
    const result = OpenAgentHarnessConfigSchema.safeParse(input)
...
describe("OpenAgentHarnessConfigSchema - browser_automation_engine", () => {
...
describe("OpenAgentHarnessConfigSchema - hashline_edit", () => {
...
describe("OpenAgentHarnessConfigSchema - git_master defaults (#2040)", () => {
