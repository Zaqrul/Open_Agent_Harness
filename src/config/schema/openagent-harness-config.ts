...
export const OpenAgentHarnessConfigSchema = z.object({
  $schema: z.string().optional(),
  /** Enable new task system (default: false) */
  new_task_system_enabled: z.boolean().optional(),
  /** Default agent name for `openagent-harness run` (env: OPENCODE_DEFAULT_AGENT) */
...
export type OpenAgentHarnessConfig = z.infer<typeof OpenAgentHarnessConfigSchema>
