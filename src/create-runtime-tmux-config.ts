import type { OpenAgentHarnessConfig, TmuxConfig } from "./config"
...
export function createRuntimeTmuxConfig(pluginConfig: { tmux?: OpenAgentHarnessConfig["tmux"] }): TmuxConfig {
