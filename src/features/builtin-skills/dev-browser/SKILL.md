...
If the extension hasn't connected yet, tell the user to launch and activate it. Point them to the dev-browser extension release artifacts from the vendor or registry they installed from.
