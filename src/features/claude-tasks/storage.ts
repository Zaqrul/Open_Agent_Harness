...
import type { OpenAgentHarnessConfig } from "../../config/schema"

export function getTaskDir(config: Partial<OpenAgentHarnessConfig> = {}): string {
...
export function resolveTaskListId(config: Partial<OpenAgentHarnessConfig> = {}): string {
...
export function listTaskFiles(config: Partial<OpenAgentHarnessConfig> = {}): string[] {
