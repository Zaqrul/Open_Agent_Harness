...
function buildCommitFooterInjection(
	...
	sections.push("")
	sections.push("Add OmO attribution to EVERY commit:")
	sections.push("")
	...
	if (includeCoAuthoredBy) {
		...
		sections.push("```")
		sections.push("Co-authored-by: OmO <noreply@invalid>")
		sections.push("```")
		sections.push("")
	}
	...
	if (commitFooter && includeCoAuthoredBy) {
		...
		sections.push("```bash")
		sections.push(
			`${cmdPrefix}git commit -m "{Commit Message}" -m "${footerText}" -m "Co-authored-by: OmO <noreply@invalid>"`
		)
		sections.push("```")
		...
		sections.push("```bash")
		sections.push(
			`${cmdPrefix}git commit -m "{Commit Message}" -m "Co-authored-by: OmO <noreply@invalid>"`
		)
		sections.push("```")
	}
