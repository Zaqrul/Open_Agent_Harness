...
import { OpenAgentHarnessConfigSchema } from "../../config"
...
describe("executeCompact lock management", () => {
  ...
  let pluginConfig: ReturnType<typeof OpenAgentHarnessConfigSchema.parse>
  ...
  beforeEach(() => {
    ...
    pluginConfig = OpenAgentHarnessConfigSchema.parse({})
