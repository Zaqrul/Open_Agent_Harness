...
import type { RuntimeFallbackConfig, OpenAgentHarnessConfig } from "../../config"
...
describe("runtime-fallback", () => {
  ...
  function createMockPluginConfigWithCategoryFallback(fallbackModels: string[]): OpenAgentHarnessConfig {
    return {
      git_master: {
        commit_footer: true,
  ...
  describe("fallback models configuration", () => {
    function createMockPluginConfigWithAgentFallback(agentName: string, fallbackModels: string[]): OpenAgentHarnessConfig {
      return {
        git_master: {
          commit_footer: true,
          include_co_authored_by: true,
