...
Cross-cutting utilities used throughout the plugin. Barrel-exported from `index.ts`. Logger writes to `/tmp/openagent-harness.log`.
...
|---------|-------------|---------|
| `logger.ts` | 62 | `/tmp/openagent-harness.log` |
