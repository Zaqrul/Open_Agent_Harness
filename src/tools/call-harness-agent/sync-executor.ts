...
export async function executeSync(
  ...
  try {
    ...
    log(`[call_harness_agent] Sending prompt to session ${sessionID}`)
    log(`[call_harness_agent] Prompt text:`, args.prompt.substring(0, 100))
    ...
    try {
      ...
      log(`[call_harness_agent] Prompt error:`, errorMessage)
