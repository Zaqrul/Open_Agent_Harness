...
describe("loadJsonFile", () => {
  ...
  it("discovers JSONC-only user config (openagent-harness.jsonc)", () => {
  ...
  "lsp": {
    "user-jsonc": {
      ...
      const userPath = join(tempBase, "openagent-harness.jsonc")
  ...
  it("discovers JSONC-only project config (.opencode/openagent-harness.jsonc)", () => {
  ...
  "lsp": {
    "project-jsonc": {
      ...
      const projectPath = join(tempProject, ".opencode", "openagent-harness.jsonc")
  ...
  "lsp": {
    "conflict": {
      ...
      writeFileSync(join(tempBase, "openagent-harness.json"), jsonContent, "utf-8")
      writeFileSync(join(tempBase, "openagent-harness.jsonc"), jsoncContent, "utf-8")
