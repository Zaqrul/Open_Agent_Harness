...
export const LSP_INSTALL_HINTS: Record<string, string> = {
  ...
  "elixir-ls": "See elixir-ls project installation documentation",
  zls: "See zls (Zig) project installation documentation",
  ...
  jdtls: "See Eclipse JDT language server installation documentation",
  "yaml-ls": "npm install -g yaml-language-server",
  "lua-ls": "See LuaLS installation documentation",
  php: "npm install -g intelephense",
  dart: "Included with Dart SDK",
  "terraform-ls": "See HashiCorp terraform-ls installation documentation",
  terraform: "See HashiCorp terraform-ls installation documentation",
  prisma: "npm install -g prisma",
  "ocaml-lsp": "opam install ocaml-lsp-server",
  texlab: "See texlab installation documentation",
  ...
  tinymist: "See tinymist installation documentation",
  "haskell-language-server": "ghcup install hls",
  bash: "npm install -g bash-language-server",
  "kotlin-ls": "See Kotlin LSP installation documentation",
}

// Synced with OpenCode upstream server list (conceptually aligned; paths may differ by version).
